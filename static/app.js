...
(function () {
    ...
    function config($routeProvider, $locationProvider, $httpProvider) {
        $routeProvider
                ...
                .when('/configemail/', {
                    controller: 'ConfigEmailController',
                    templateUrl: 'email/configemail.view.html?v=' + posConfig.TEMPLATE_CONFIGEMAIL_VERSION
                })
                .when('/historysendemail/', {
                    controller: 'HistorySendEmailController',
                    templateUrl: 'historysendemail/historysendemail.view.html?v=' + posConfig.TEMPLATE_HISTORYSENDEMAIL_VERSION
                })
